...
def compute_global_std(ratings_df, rating_col=cfg.RATING_COL):
    
    '''
    Computes the global standard deviation of all ratings in the ratings dataset.
    ...
    global_std = ratings_df.select(F.stddev(rating_col).alias('global_std')).first()['global_std']
